...
//allows us to parse HTML tags in angular injected content
...
app.controller("ModuleController", function() {
  (function(){
     $('#main-head').text('The Significance of 1492');
  }());
